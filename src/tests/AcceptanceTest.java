...
public class AcceptanceTest {
    ...
    public void setUp() throws OperationImpossible, InvariantBroken {
        ...
        m1.ajouterVideo("Test_code1", "Test_salle1", "Test_rayon1", "Test_titre1", "Test_auteur1",
                "Test_annee1", "Test_genre1", 120, "Test_mentionLegale1");
        m1.ajouterVideo("Test_code2", "Test_salle1", "Test_rayon1", "Test_titre2",
                "Test_auteur2", "Test_annee2", "Test_genre1", 120, "Test_mentionLegale1");
        m1.ajouterVideo("Test_code3", "Test_salle1", "Test_rayon1", "Test_titre3",
                "Test_auteur3", "Test_annee3", "Test_genre1", 120, "Test_mentionLegale1");
        m1.ajouterVideo("Test_code4", "Test_salle1", "Test_rayon1", "Test_titre4", "Test_auteur1",
                "Test_annee1", "Test_genre1", 120, "Test_mentionLegale1");
        m1.ajouterVideo("Non_empruntable", "Test_salle1", "Test_rayon1", "Test_titre3",
                "Test_auteur3", "Test_annee3", "Test_genre1", 120, "Test_mentionLegale1");
