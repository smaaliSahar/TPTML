...
public final class FicheEmprunt implements Serializable {
     ...
     * @throws OperationImpossible si deja depasse. 
     */
    public boolean premierRappel() throws OperationImpossible, InvariantBroken {
        if(!depasse) {
            depasse = true;
            client.marquer();
     ...
     * @throws OperationImpossible si emprunt non en retard
     * @return true si changement de date de relance false sinon
     */
    public boolean relancer() throws OperationImpossible {
        Date dateActuelle = Datutil.dateDuJour();
        if (depasse) {
        ...
        throw new OperationImpossible("Relancer sur FicheEmprunt non en retard");
    }
